...
BME280_RESULT BME280_Read_UP(int32_t *UP) {
	...
	*UP = 0x80000;
	...
	if(BME280_ReadRegs(BME280_REG_PRESS_MSB,(uint8_t *)buf,3) < 0) return BME280_ERROR;
...
BME280_RESULT BME280_Read_UT(int32_t *UT) {
	...
	*UT = 0x80000;
	...
	if(BME280_ReadRegs(BME280_REG_TEMP_MSB,(uint8_t *)buf,3) < 0) return BME280_ERROR;
...
BME280_RESULT BME280_Read_UH(int32_t *UH) {
	...
	*UH = 0x8000;
	...
	if(BME280_ReadRegs(BME280_REG_HUM_MSB,(uint8_t *)buf,2) < 0) return BME280_ERROR;
