...
#define USBD_PID_FS                   0xC9  //0xC9 //0x5740
#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      "CDR"
#define USBD_PRODUCT_HS_STRING        "DualCDC in HS Mode"
#define USBD_PRODUCT_FS_STRING        "DualCDC in FS Mode"
#define USBD_CONFIGURATION_STRING_HS  "DualCDC Config in HS"
#define USBD_INTERFACE_STRING_HS      "DualCDC Interface i HS"
#define USBD_CONFIGURATION_STRING_FS  "DualCDC Config in FS"
#define USBD_INTERFACE_STRING_FS      "DualCDC Interface in FS"
...
uint8_t *USBD_CMPST_USRStringDesc(USBD_SpeedTypeDef speed, uint8_t idx, uint16_t *length);
...
USBD_DescriptorsTypeDef COMPOSITE_Desc = {
  USBD_CMPST_DeviceDescriptor,
  USBD_CMPST_LangIDStrDescriptor,
  USBD_CMPST_ManufacturerStrDescriptor,
  USBD_CMPST_ProductStrDescriptor,
  USBD_CMPST_SerialStrDescriptor,
  USBD_CMPST_ConfigStrDescriptor,
  USBD_CMPST_InterfaceStrDescriptor,
};
